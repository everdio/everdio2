...
namespace Component\Core\Adapter\Wrapper\Controller\Model {
    ...
    abstract class Http extends \Component\Core\Adapter\Wrapper\Controller\Model {
        ...
        public function setup(): void {
            ...
            $this->routing = \DIRECTORY_SEPARATOR . \implode(\DIRECTORY_SEPARATOR, \array_filter(\explode(\DIRECTORY_SEPARATOR, \str_replace("?" . $this->server["QUERY_STRING"], false, \ltrim($this->server["REQUEST_URI"], \DIRECTORY_SEPARATOR)))));
