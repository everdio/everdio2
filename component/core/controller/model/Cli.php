    ...
    class Cli extends \Component\Core\Controller\Model {
        public function __construct(array $_parameters = []) {
            parent::__construct([
                ...
                "styles" => new Validation(["bright" => 1, "italic" => 3, "underline" => 4, "blinking" => 5, "strikethrough" => 9, "black" => 30, "red" => 31, "green" => 32, "yellow" => 33, "blue" => 34, "magenta" => 35, "cyan" => 36, "white" => 37, "blackbg" => 40, "redbg" => 41, "greenbg" => 42, "yellowbg" => 44,"bluebg" => 44, "magentabg" => 45, "cyanbg" => 46, "lightgreybg" => 47], [new Validator\IsArray])
            ] + $_parameters);
        }
        
        final public function echo(string $text, array $format = ["white", "blackbg"]) {
            return (string) \sprintf("\033[%sm%s\033[0m", \implode(";", \array_flip(\array_intersect(\array_flip($this->styles), $format))), $text);
        }
