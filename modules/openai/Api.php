    ...
    class Api extends \Component\Core\Adapter {
        ...
        public function __construct() {
            parent::__construct([
                ...
                "key" => new Validation("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", [new Validator\IsString]),
                ...
                "max_tokens" => new Validation(512, [new Validator\IsInteger]),
                "temperature" => new Validation(1, [new Validator\IsFloat]),
