...
namespace Modules\Everdio\Library2\ECms {
    class Properties extends Modules\Everdio\Library2\ECms {
        public function __construct(array $values = []) {
            $this->add("mapping", new \Components\Validation(["document_id" => "DocumentId", "environment_id" => "EnvironmentId", "property" => "Property", "content" => "Content"], [new \Components\Validator\IsArray], \Components\Validation::NORMAL));
$this->add("table", new \Components\Validation("properties", [new \Components\Validator\IsString], \Components\Validation::NORMAL));
